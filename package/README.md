...
1. Click **Manual Download** on this page, and open the zip.
...
framework that comes in the same zip. Keel is released under the Mozilla
Public License 2.0, with its licence in `Keel\Keel-LICENSE.txt`, and its
source code is at https://github.com/VysesDarkheart/keel. Keel in turn starts
